...
txt = open('E:/Omics/Result/Lac_sites.txt', mode='r')
txt = txt.readlines()
Seq_dict = {}
...
pos_set = open('E:/Omics/Kla/pos_Kla.txt', mode='w')
...
neg_set = open('E:/Omics/Kla/transfer/neg_function_Kla.txt', mode='w')
for ns in neg_usp10.keys():
