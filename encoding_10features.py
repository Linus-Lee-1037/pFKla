...
def command_pssm(input_file, output_file, pssm_file, DBname):
    import subprocess
    cmd1 = r'./BLAST/blast-BLAST_VERSION+/bin/psiblast -query ' + input_file + ' -db ' + DBname + ' -num_iterations 3 -num_threads 12 -out ' + output_file + ' -out_ascii_pssm ' + pssm_file #path of psiblast
...
def ss1(list10, dic):
    ...
    OldPSMMdir = dic + '/ZFilepathPSSM2'
    origin_outfile = dic + '/asa_result2'
...
storage10features('./', namelist, ACF, AAindex, binary, gpn, CKSAAPs, PseAAC,
